...
You just received an urgent request from your project stakeholders to fix your web app. You need to jump directly into the project and add correct a mistake where the site adds 100 lemons to a customer's bag when its only supposed to be 10! You need to make the changes and you don't have the local development environment necessary. Not to worry, you know you can use **github.dev** in the browser to make these changes.
